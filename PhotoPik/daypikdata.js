...
// 2
{	"title":"2.Select Day",
"text":"Selecting a day with 'DatePicker' and Tapping bellow 'Show Photo' button, photos of that day would be shown by year descending. Top left 'Action' button shows 'Assistant' View. Top right button show seleted date history list.",
"imgSource":"day-selectdate-en.jpg"},
...
// 2
{	"title":"2. 日付を選択する",
"text":"日付ピッカーで選択後、下の「写真を表示する」ボタンをタップすると、選択した日付に撮影された写真が年の新しい順にまとめられて表示されます。左上の「アクション」ボタンをタップすると「アシスタント」画面が表示されます。右上のボタンは選択した日付の履歴を表示します。",
"imgSource":"day-selectdate-ja.jpg"},
