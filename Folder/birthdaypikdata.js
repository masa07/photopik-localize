...
// 2
{	"title":"2.Add Person with Birthday",
"text":"If you don't have any birthday person in your Contacts, you need to add at least one person. To complete inputting person data, you should tap 'Done' - 'All Contacts' - 'Cancel'. ",
"imgSource":"addperson-en.jpg"},

// 3
{	"title":"3.Select Birthday",
"text":"Tapping a birthday, photos of that day would be shown by year descending. Birthday person image which is same date of today is highlited by 'Happy Birthday' image. Top left 'Action' button shows 'Assistant' View. Top Right 'Contacts' button shows 'Select Action' sheet to edit your contacts.",
"imgSource":"birthday-list-en.png"},
...
"imgSource":"birthday-photo-en.png"},
...
// 2
{	"title":"2. 誕生日を登録する",
"text":"連絡先に誕生日の登録が無い場合は、追加する必要があります。登録が終わったら、「完了」 - 「すべての連絡先」 - 「キャンセル」の順に選択すれば終了できます。",
"imgSource":"addcontact-ja.jpg"},

// 3
{	"title":"3. 誕生日を選択する",
"text":"誕生日をタップすると、その日付に撮影された写真が年の新しい順にまとめられて表示されます。当日が誕生日の欄には'Happy Birthday'の画像で飾られます。左上の「アクション」ボタンをタップすると「アシスタント」画面が表示されます。右上の「連絡先」ボタンをタップすると、アクションシートが表示されます。連絡先の「編集」か「追加」を選択してください。",
"imgSource":"birthday-list-ja.png"},

// 4
{	"title":"4. 写真を見る",
"text":"表示される写真の撮影された年がはじめに表示されます。画面の左右をタップするか、スワイプすることでページをめくることができます。ページをめくると、ステータスバーとナビゲーションバーが隠れます。誕生日のリストに戻る場合は、画面の中央付近をタップしてステータスバーとナビゲーションバーを表示させて、左上の「誕生日」をタップしてください。右上の「+」ボタンをタップするとカメラが起動して撮影することができます。",
"imgSource":"birthday-photo-ja.png"},
...
// 6
{	"title":"メッセージを送る",
"text":"様々な方法でメッセージを送ることができます。このアプリ関するご意見は、「#PhotPik」タグでツイートしてください。次のバージョンの参考にさせて頂きます。",
